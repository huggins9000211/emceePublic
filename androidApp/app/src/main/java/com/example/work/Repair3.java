...
public class Repair3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Repair.repair.put("Elbows 1.5 in", elboes);
                Repair.repair.put("Couplings 1.5 in", couplings);
                Repair.repair.put("Male Adaptor 1.5 in", male);
                Repair.repair.put("Female Adaptor 1.5 in", female);
                Repair.repair.put("Poly Adaptor 1.5 in", poly);
                Repair.repair.put("Ts 1.5 in", ts);
                Repair.repair.put("Street Els 1.5 in", street);
                Repair.repair.put("Valves 1.5 in", valves);
                Repair.repair.put("Clamps 1.5 in", clamps);
                Repair.repair.put("Unions 1.5 in", unions);
                Repair.repair.put("Nipples 1.5 in", nipples);


                Intent intent = new Intent(Repair3.this, Repair4.class);
